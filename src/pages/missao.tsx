  ...
  return (
    <Layout>
      <div className="flex flex-col items-center min-h-screen pt-8 md:pt-12">
        <h1 className="text-4xl font-bold text-white mb-10">Missão</h1>
        <div className="w-full max-w-5xl px-4">
          <div className="missao-glow p-8">
            <div className="w-full bg-black bg-opacity-70 rounded-lg shadow-lg p-8 space-y-6">
