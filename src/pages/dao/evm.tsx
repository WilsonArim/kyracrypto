...
const protocolos = [
  {
    ...
    funcao: 'DAO / GOVERNANÇA',
    icon: "/images/barra_de_navegacao/uniswap.jpg"
  },
  {
    nome: 'Aave Governance',
    url: 'https://governance.aave.com/',
    landing: 'https://aave.com/',
    twitter: 'https://twitter.com/AaveAave',
    documentation: 'https://docs.aave.com/',
    defillama: 'https://defillama.com/protocol/aave',
    github: 'https://github.com/aave/governance-v2',
    discord: 'https://discord.com/invite/aave',
    telegram: 'https://t.me/Aave_Official',
    funcao: 'DAO / GOVERNANÇA',
    icon: "/images/barra_de_navegacao/aave.jpg"
  },
  {
    nome: 'MakerDAO',
    url: 'https://vote.makerdao.com/',
    landing: 'https://makerdao.com/',
    twitter: 'https://twitter.com/MakerDAO',
    documentation: 'https://docs.makerdao.com/',
    defillama: 'https://defillama.com/protocol/maker',
    github: 'https://github.com/makerdao/governance-portal-v2',
    funcao: 'DAO / GOVERNANÇA',
    icon: "/images/barra_de_navegacao/maker.jpg"
  },
  {
    nome: 'Curve DAO',
    url: 'https://curve.fi/dao/ethereum/proposals/',
    landing: 'https://curve.fi/',
    twitter: 'https://twitter.com/CurveFinance',
    documentation: 'https://docs.curve.fi/',
    defillama: 'https://defillama.com/protocol/curve-finance',
    github: 'https://github.com/curvefi/curve-dao-contracts',
    discord: 'https://discord.gg/curvefi',
...
const CATEGORY_PATH = "DAO - EVM";

export default function DaoEVM() {
  return (
    <Layout>
      <div className="container mx-auto py-8">
        <h1 className="text-3xl font-bold text-cyan-400 mb-8">DAO - EVM</h1>
