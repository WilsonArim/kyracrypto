...
const metricas = [
  { nome: 'TVL Lending', valor: '$25B', variacao: '+7%', periodo: '7d', interpretacao: 'Alto' },
  { nome: 'Protocolos', valor: '35', variacao: '+2', periodo: '7d', interpretacao: 'Alto' }
];

const graficos = [
  { titulo: 'Lending DeFi', link: 'https://defillama.com/lending', fonte: 'DefiLlama' }
];
  ...
  return (
    <Layout>
      <div className="container mx-auto py-8">
        <h1 className="text-3xl font-bold text-cyan-400 mb-8">Lending DeFi</h1>
