...
const metricas = [
  { nome: 'TVL Derivativos', valor: '$8B', variacao: '+6%', periodo: '7d', interpretacao: 'Alto' },
  { nome: 'Protocolos', valor: '12', variacao: '+1', periodo: '7d', interpretacao: 'Alto' }
];

const graficos = [
  { titulo: 'Derivativos DeFi', link: 'https://defillama.com/derivatives', fonte: 'DefiLlama' }
];

export default function DerivativosDeFi() {
  return (
    <Layout>
      <div className="container mx-auto py-8">
        <h1 className="text-3xl font-bold text-cyan-400 mb-8">Derivativos DeFi</h1>
