...
const metricas = [
  { nome: 'TVL RWA', valor: '$1.2B', variacao: '+9%', periodo: '7d', interpretacao: 'Alto' },
  { nome: 'Protocolos', valor: '8', variacao: '+1', periodo: '7d', interpretacao: 'Alto' }
];

const graficos = [
  { titulo: 'RWA DeFi', link: 'https://maple.finance/', fonte: 'Maple Finance' }
];
  ...
  return (
    <Layout>
      <div className="container mx-auto py-8">
        <h1 className="text-3xl font-bold text-cyan-400 mb-8">RWA DeFi</h1>
