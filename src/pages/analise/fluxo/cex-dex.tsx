...
const metricas = [
  { nome: 'Fluxo CEX', valor: '$3.1B', variacao: '+6%', periodo: '7d', interpretacao: 'Alto' },
  { nome: 'Fluxo DEX', valor: '$2.2B', variacao: '+4%', periodo: '7d', interpretacao: 'Alto' }
];

const graficos = [
  { titulo: 'Fluxo CEX/DEX', link: 'https://defillama.com/cex-asset-flows', fonte: 'DefiLlama' }
];

export default function FluxoCexDex() {
  return (
    <Layout>
      <div className="container mx-auto py-8">
        <h1 className="text-3xl font-bold text-cyan-400 mb-8">Fluxo CEX/DEX</h1>
