...
const metricas = [
  { nome: 'TVL Pools', valor: '$85B', variacao: '+5%', periodo: '7d', interpretacao: 'Alto' },
  { nome: 'Volume Pools', valor: '$25B', variacao: '+7%', periodo: '7d', interpretacao: 'Alto' }
];

const graficos = [
  { titulo: 'Liquidez em Pools', link: 'https://defillama.com/pools', fonte: 'DefiLlama' }
];
  ...
  return (
    <Layout>
      <div className="container mx-auto py-8">
        <h1 className="text-3xl font-bold text-cyan-400 mb-8">Liquidez</h1>
