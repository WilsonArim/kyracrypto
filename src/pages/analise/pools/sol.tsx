...
const metricas = [
  { nome: 'TVL Solana', valor: '$12B', variacao: '+7%', periodo: '7d', interpretacao: 'Alto' },
  { nome: 'Volume Solana', valor: '$4B', variacao: '+5%', periodo: '7d', interpretacao: 'Alto' }
];

const graficos = [
  { titulo: 'Pools Solana', link: 'https://defillama.com/pools', fonte: 'DefiLlama' }
];
  ...
  return (
    <Layout>
      <div className="container mx-auto py-8">
        <h1 className="text-3xl font-bold text-cyan-400 mb-8">Pools Solana</h1>
