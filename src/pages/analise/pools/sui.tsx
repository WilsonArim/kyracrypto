...
const metricas = [
  { nome: 'TVL SUI', valor: '$2B', variacao: '+8%', periodo: '7d', interpretacao: 'Médio' },
  { nome: 'Volume SUI', valor: '$0.8B', variacao: '+3%', periodo: '7d', interpretacao: 'Médio' }
];

const graficos = [
  { titulo: 'Pools SUI', link: 'https://defillama.com/pools', fonte: 'DefiLlama' }
];
