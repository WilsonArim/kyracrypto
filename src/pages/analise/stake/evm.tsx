...
const metricas = [
  { nome: 'APY Médio', valor: '7.5%', variacao: '+0.5%', periodo: '7d', interpretacao: 'Alto' },
  { nome: 'Tokens Staked', valor: '12M', variacao: '+2%', periodo: '7d', interpretacao: 'Alto' },
  { nome: 'Validadores', valor: '350K', variacao: '+1%', periodo: '7d', interpretacao: 'Alto' }
];

const graficos = [
  { titulo: 'Staking EVM', link: 'https://www.stakingrewards.com/', fonte: 'Staking Rewards' }
];
  ...
  return (
    <Layout>
      <div className="container mx-auto py-8">
        <h1 className="text-3xl font-bold text-cyan-400 mb-8">Stake EVM</h1>
