...
const metricas = [
  { nome: 'APY Médio', valor: '5.8%', variacao: '+0.2%', periodo: '7d', interpretacao: 'Médio' },
  { nome: 'Tokens Staked', valor: '1.1M', variacao: '+0.8%', periodo: '7d', interpretacao: 'Médio' },
  { nome: 'Validadores', valor: '400', variacao: '+0.2%', periodo: '7d', interpretacao: 'Médio' }
];

const graficos = [
  { titulo: 'Staking SUI', link: 'https://suivision.xyz/', fonte: 'Suivision' }
];
  ...
  return (
    <Layout>
      <div className="container mx-auto py-8">
        <h1 className="text-3xl font-bold text-cyan-400 mb-8">Stake SUI</h1>
